const About = () => {
    return ( 
        <div className="max-w-xl max-h-90 flex flex-col justify-between justify-self-center gap-8 p-5 shadow-md shadow-gray-700 sm:mx-20 mx-5">
            <h1 className="text-4xl font-mono">ABOUT ME</h1>
            <h3 className="text-lg font-semi-bold">I go by the name Stephen, a front-end developer currently studying computer science Ajayi Crowther University,Oyo,Nigeria. I started writing codes 2019 and have learnt quite a number of technologies from then till date. I am open to junior developer roles or freelance gigs. Technlogies i have learnt  and work with are listed below :
            </h3>
